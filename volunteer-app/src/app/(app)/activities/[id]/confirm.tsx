      ...
      <Box paddingTop="xl" alignItems="center" marginHorizontal="m" flex={1}>
        ...
        <Box width="70%" marginBottom="l">
          <Text variant="header" lineHeight={38} textAlign="center">
            {t("changeReuqestSent", "Change request sent")}
          </Text>
        </Box>

        <Text variant="secondary" textAlign="center">
          <Trans i18nKey="changeRequestMessage">
            The organization has received your change request for the activity. Stay tuned for a
            confirmation.
          </Trans>
        </Text>
      </Box>
